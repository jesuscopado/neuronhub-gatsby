...
Entonces, ¿por qué seguimos asociando a Lamarck con la herencia de los caracteres adquiridos? Los seguidores de Darwin posteriores (los neodarwinistas de los siglos XIX y XX) quisieron diferenciar sus nuevas teorías basadas en la selección, de las viejas ideas de la llamada “herencia blanda”. Necesitaban a alguien que representara esa forma de pensar anticuada, y Lamarck encajaba perfectamente en ese papel. Así surgió la etiqueta “lamarckiano”, que se usa para referirse a todo lo relacionado con la herencia de los caracteres adquiridos. 
...
En estos gusanos, se identificó un mecanismo llamado interferencia por ARN (RNA interference o RNAi), mediante el cual pequeñas moléculas de ARN regulan la expresión génica silenciando genes específicos. Resultó que este mecanismo está conservado en otros organismos, incluidos los humanos. Así que cuando hablo de herencia mediada por ARN, me refiero a moléculas de ARN que pueden regular la expresión génica también en las siguientes generaciones, a través de este mismo proceso. 
...
Para entenderlo mejor, hicimos experimentos evolutivos en el laboratorio. Descubrimos que cuando los gusanos se crían a altas temperaturas, esto cambia el conjunto de pequeños ARN (sRNA) en su esperma y perjudica la función espermática de su descendencia. Como estos gusanos son hermafroditas (producen tanto esperma como óvulos), tener esperma defectuoso significa que no pueden autofertilizarse. En respuesta, secretan una hormona que atrae a los machos, lo que los lleva a aparearse con otros (Toker et al., 2022). 
...
Además, descubrimos los genes que controlan cuánto tiempo duran estos efectos heredados: los genes motek (Houri-Ze’evi et al., 2016). Encontramos que existen reglas específicas que determinan cómo se transmiten estas respuestas a lo largo de las generaciones y entre diferentes linajes de gusanos, lo que explica por qué algunos heredan muchos pequeños ARN y otros no. 

Más recientemente, hemos mostrado que es suficiente producir pequeños ARN en el cerebro de un gusano para generar cambios transgeneracionales (Posner et al., 2019). Esto abre la posibilidad de que la actividad cerebral pueda influir en la siguiente generación, algo que nunca se había demostrado antes. Cuando modificamos los niveles de pequeños ARN específicamente en el cerebro, no solo se altera la herencia de ARN, sino también el comportamiento de la descendencia. Por ejemplo, cambiando la producción de estas moléculas en el cerebro parental modifica la eficiencia con la que sus descendientes buscan alimento. 
...
Si este tipo de herencia también ocurre en humanos, las implicaciones serían enormes. Significaría que, al hablar de herencia, no deberíamos limitarnos a las secuencias de ADN, sino que deberíamos incluir el ARN. 
